...
Route::middleware(['auth', 'checkrole:owner'])->prefix('owner')->group(function () {
...
Route::middleware(['auth', 'checkrole:manager'])->prefix('manager')->group(function () {
...
Route::middleware(['auth', 'checkrole:developer'])->prefix('developer')->group(function () {
