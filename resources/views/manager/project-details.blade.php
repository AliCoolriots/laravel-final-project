...
@section('content')
    <div class="container mb-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="/manager/projects" class="btn btn-outline-primary mb-4">Back to Projects</a>
        </div>
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered mt-4">
                    <tbody>
                        ...
                        {{-- Uncomment the following section if you have the relationship defined --}}
                        {{-- 
                        <tr>
                ...
                <div class="mt-4 d-flex gap-2">
                    <a href={{ "/manager/projects/{$project->id}/progress" }} class="btn btn-outline-primary">Progress</a>
